module.exports =  [
    ...
    },
    {
      ...
      icon        : '',
      title       : 'SpeakBagus',
      subtitle    : 'A simple language learning platform',
    ...
    },
    {
      ...
      github      : 'SGTinkers/terawhere-laravel',
      show        : true,
      deprecated  : true,
    ...
    },
    {
      ...
      url         : '',
      github      : 'xmodulus/Redlist-Chrome-Extension',
      show        : true,
      deprecated  : true,
    ...
    },
    {
      ...
      icon        : '',
      title       : 'Makanhero API',
      subtitle    : 'A simple application to prevent food wastage.',
      url         : '',
      github      : 'modulus/makanhero-api',
      show        : true,
      deprecated  : true,
      description : '',
      date_start  : '2018-01-01',
